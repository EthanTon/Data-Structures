...
Purpose: Implement a Queue class using a Singly Linked List to manage a collection of Currency objects and perform usual operations like enqueue, dequeue, peek, print.
"""
